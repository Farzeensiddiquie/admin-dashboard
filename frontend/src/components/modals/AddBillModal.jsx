        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Dashboard UI Design"
              className="w-full px-4 py-2 bg-[#383838] border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              className="w-full px-4 py-2 bg-[#383838] border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none"
            />
          </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2  bg-black hover:bg-[#121212] text-white rounded-lg font-medium transition-colors"
            >
              Add Task
            </button>
          </div>
